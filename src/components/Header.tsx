            ...
            <div className="relative z-10 flex flex-col gap-6 sm:flex-row sm:justify-between sm:items-center">
                ...
                <div className="flex flex-col gap-6 sm:flex-row sm:gap-8 sm:items-center">
                    <nav className="flex flex-col gap-6 text-black text-base sm:text-lg sm:flex-row sm:gap-8">
                        <div className="flex items-center justify-center rounded-md px-3 p-2 w-fit bg-[#c8cc92] transition hover:opacity-80"><a href="/#about">About</a></div>
                        <div className="flex items-center justify-center rounded-md px-3 p-2 w-fit bg-[#c8cc92] transition hover:opacity-80"><a href="/#projects">Portfolio</a></div>
                        <div className="flex items-center justify-center rounded-md px-3 p-2 w-fit bg-[#c8cc92] transition hover:opacity-80"><a href="/#contact">Contact</a></div>
                    </nav>
                    <div>
                        <Github 
                            fill="white"
